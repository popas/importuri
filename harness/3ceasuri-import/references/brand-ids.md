...
Last updated: 2026-07-30. Added `Timex`(49), `Seksy`(50), `Edox`(51). Added `Ralmor`(48). Added `Westbury`(47), `Tressa Lux`(46), `NET`(45). Added `Jovial`(44), `Gruppo Gamma`(43), `Junghans`(42), `Chaika`(41). Added `Slava`(39), `Fresard`(40) on 2026-07-24. Brand 8 renamed `Racheta` → `Raketa` (2026-07-22).
